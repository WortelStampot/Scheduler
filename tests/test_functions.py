...
class Test_isOpenFor:
    ...
    def test01(self):
        ...
        schedule = Schedule(roles=[], staff=[], schedule={})
    ...
    def test02(self):
        ...
        schedule = Schedule(roles=[], staff=[], schedule={anotherTuesdayRole: staff})
    ...
    def test04(self):
        ...
        staff = Staff(name='atlas', maxShifts=4, availability=None)
        role = Role(name='Aux', day=Weekdays.TUESDAY, callTime=datetime.time(hour=18, minute=00))
        schedule = Schedule(roles=[], staff=[], schedule={role: staff})
