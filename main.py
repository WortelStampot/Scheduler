...
def startingSchedule(Schedule):
    ...
    #where to place 'edge case logging' like this?
    ...
    # Schedule.staff is a collection of Staff object for the week.
        ...
        #this creates new unique Staff objects which are now dispersed throughout Schedule.schedule
        #I still think of the StaffCollection as a list of unique Staff objects, unduplicated.
        #Practically I don't know how to set that up with the matching algorithm, and I don't know how important it is.
        # So- for now Schedule.staff becomes a the duplicated list of the Staff collection.
